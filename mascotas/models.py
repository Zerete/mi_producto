...
class ReporteHallazgo(models.Model):
    mascota = models.ForeignKey(Mascota, on_delete=models.CASCADE, related_name='hallazgos')
    ...
    def __str__(self):
        return f"Hallazgo para {self.mascota.nombre}"